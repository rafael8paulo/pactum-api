# Spec: Cadastrar Despesa

## Purpose

Define o contrato e o modelo de domínio para o cadastro de despesas via `POST /api/v1/despesas`, incluindo os enums de status e categoria utilizados em todo o módulo de despesas.
