...
Especificação da funcionalidade de histórico anual financeiro. Define o endpoint `GET /api/v1/resumo/anual`, retornando os resumos dos 12 meses do ano e os totais anuais agregados.
