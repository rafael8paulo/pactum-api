...
Configuração da conexão com PostgreSQL via profiles Spring, provisionamento do banco para desenvolvimento local via Docker Compose e exposição de health check do banco via Spring Actuator.
