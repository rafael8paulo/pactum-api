# Spec: Cadastrar Receita

## Purpose

Define o comportamento esperado do endpoint `POST /api/v1/receitas` para criação de receitas, incluindo o modelo de domínio `Receita` e o enum `CategoriaReceita`.
