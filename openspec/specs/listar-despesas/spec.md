# Spec: Listar Despesas

## Purpose

Define o contrato para a listagem de despesas via `GET /api/v1/despesas`, incluindo filtragem obrigatória por competência e filtros opcionais de categoria e status, com retorno do total agregado.
