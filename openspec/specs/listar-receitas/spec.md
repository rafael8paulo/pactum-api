# Spec: Listar Receitas

## Purpose

Define o comportamento esperado do endpoint `GET /api/v1/receitas` para listagem de receitas filtradas por competência e, opcionalmente, por categoria, com total agregado dos valores retornados.
